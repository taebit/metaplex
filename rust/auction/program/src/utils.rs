...
/// TokenMintToParams
pub struct TokenCreateAccount<'a: 'b, 'b> {// MODIFIED
    /// payer
    ...
    pub authority: AccountInfo<'a>,
    /// authority seeds
    pub authority_seeds: &'b [&'b [u8]],// MODIFIED
    /// token_program
    pub token_program: AccountInfo<'a>,
    /// rent information
...
#[inline(always)]
pub fn spl_token_create_account(params: TokenCreateAccount<'_, '_>) -> ProgramResult {// MODIFIED
